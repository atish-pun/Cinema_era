...
class FavouriteAdapter extends RecyclerView.Adapter<FavouriteAdapter.ViewHolder> {
    ...
    public FavouriteAdapter(Context ctx, List<Film> favourite) {
        this.ctx = ctx;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        holder.film_name.setText(favourite.get(position).getFilm_name());
        holder.RunTime.setText(favourite.get(position).getTime());
        Picasso.get().load(favourite.get(position).getFilm_image()).into(holder.film_image);
        holder.film_image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gallery = new Intent(ctx ,Film_gallery.class);
                gallery.putExtra("Film images",favourite.get(position).getFilm_image());
                gallery.putExtra("Film names",favourite.get(position).getFilm_name());
                ...
                gallery.putExtra("Release date",favourite.get(position).getDate());
                gallery.putExtra("Run time",favourite.get(position).getTime());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ConstraintLayout favourite_layout;
        public ViewHolder(@NonNull View itemView) {
            ...
            favourite_layout = itemView.findViewById(R.id.favourite_layout);
        }
    }
}
