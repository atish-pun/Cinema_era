                ...
                try {
                    ...
                    if (object.getInt("status") == 200) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            Film.FavouriteInfo favouriteInfo = new Film.FavouriteInfo(id, token, movies_id, uid, A_name, A_poster, Trailer_videos, Cast, Director, Release_date, Run_time, Language, Overview);
